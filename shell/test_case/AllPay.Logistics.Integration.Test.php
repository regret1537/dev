 ...
 * @filesource ./logistic/AllPay.Logistics.Integration.php
 * @filesource ./AllPay.Logistics.Integration.Test.Config.php
 * @version    1.0
 */
 
include(__DIR__ . "/SDK/AllPay.Logistics.Integration.php");
include(__DIR__ . "/config/AllPay.Logistics.Integration.Test.Config.php");
 ...
 * 統一電子地圖串接(CvsMap)
 */
$sTest_Subject = "allPay 統一電子地圖串接(CvsMap)";
$sTest_Result = "";
 ...
 */
$sTest_Subject = "allPay 幕後宅配物流訂單產生(BGCreateShippingOrder)";
$sTest_Result = "";
$sHome_URL = "http://www.sample.com.tw";
try {
	$oA_L = new AllpayLogistics();
 ...
 */
$sTest_Subject = "allPay 超商取貨物流訂單產生(CreateShippingOrder)";
$sTest_Result = "";
$sHome_URL = "http://www.sample.com.tw";
try {
	$oA_L = new AllpayLogistics();
 ...
 */
$sTest_Subject = "allPay 幕後超商取貨物流訂單產生(BGCreateShippingOrder)";
$sTest_Result = "";
$sHome_URL = "http://www.sample.com.tw";
try {
	$oA_L = new AllpayLogistics();
 ...
 */
$sTest_Subject = "allPay 宅配逆物流訂單產生(CreateHomeReturnOrder)";
$sTest_Result = "";
$sHome_URL = "http://www.sample.com.tw";
try {
	$oA_L = new AllpayLogistics();
 ...
 */
$sTest_Subject = "allPay 超商取貨逆物流訂單(全家超商 B2C)(CreateFamilyB2CReturnOrder)";
$sTest_Result = "";
$sHome_URL = "http://www.sample.com.tw";
try {
	$oA_L = new AllpayLogistics();
 ...
 */
$sTest_Subject = "allPay 全家逆物流核帳(全家超商 B2C)(CheckFamilyB2CLogistics)";
$sTest_Result = "";
$sHome_URL = "http://www.sample.com.tw";
try {
	$oA_L = new AllpayLogistics();
