...
*  付款方式：超商代碼
*/
class ECPay_CVS extends Verification
{
...
* 付款方式 : BARCODE 
*/
class ECPay_BARCODE extends Verification
{
    public  $arPayMentExtend = array(
                            'Desc_1'           =>'',
                            'Desc_2'           =>'',
...
class ECPay_ATM extends Verification
{
    public  $arPayMentExtend = array(
                            'ExpireDate'       => 3,
                            'PaymentInfoURL'   => '',
...
class ECPay_WebATM extends Verification
{
    public  $arPayMentExtend = array();
...
* 付款方式 : 信用卡
*/
class ECPay_Credit extends Verification
{
    public $arPayMentExtend = array(
                                    "CreditInstallment" => 0,
                                    "InstallmentAmount" => 0, 
...
*  付款方式：全功能
*/
class ECPay_ALL extends Verification
{
    public  $arPayMentExtend = array();
