<?php
	...
	class plgHikashoppaymentallpay_[lazy=payment] extends hikashopPaymentPlugin {
		var $accepted_currencies = array('TWD');
        
		var $multiple = true;
		var $name = 'allpay_[lazy=payment]';
        ...
        function getPaymentDefaultValues(&$element) {
            $element->payment_name = '[歐付寶][lazy=payment_tw_desc]';
            $element->payment_description = '您可透過此付款方式進行[lazy=payment_tw_desc]付款';
		...
		function onAfterOrderConfirm(&$order,&$methods,$method_id) {
            ...
            try {
                ...
                $red_html = $AIO->CheckOutString(null);
                echo $red_html;
                exit;
            } catch(Exception $e) {
                $app = JFactory::getApplication();
